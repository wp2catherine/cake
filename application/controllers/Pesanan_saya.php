...
class Pesanan_saya extends CI_Controller
{
	...
	{
		$this->form_validation->set_rules('atas_nama', 'Atas Nama', 'required', array('required' => '%s Must Be Filled !!!'));
		if ($this->form_validation->run() == TRUE) {
			...
			if (!$this->upload->do_upload($field_name)) {
				...
				$this->session->set_flashdata('pesan', 'Proof of Payment Successfully Uploaded !!!');
	...
	public function diterima($id_transaksi)
	{
		...
		$this->session->set_flashdata('pesan', 'Order Has Been Received !!!');
		redirect('pesanan_saya');
	}
}
?>
