...
class Rajaongkir extends CI_Controller
{
	...
	public function provinsi()
	{
		...
		if ($err) {
			...
			echo "<option value=''>--Select Provinsi--</option>";
	...
	public function kota()
	{
		...
		if ($err) {
			...
			echo "<option value=''>--Select Kota--</option>";
	...
	{
		echo '<option value="">--Select Expedisi--</option>';
	...
	public function paket()
	{
		...
		if ($err) {
			...
			echo "<option value=''>--Select Paket--</option>";
