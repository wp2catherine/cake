<div class="col-md-12">
	<div class="card card-primary">
		<div class="card-header">
			<h3 class="card-title">Add Image Product : <?= $barang->nama_barang ?></h3>
		...
		<div class="card-body">
			...
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
						...
						<input name="ket" class="form-control" placeholder="Caption" value="<?= set_value('ket') ?>">
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
			...
			<div class="form-group">
				...
				<a href="<?= base_url('gambarbarang') ?>" class="btn btn-success btn-sm">Back</a>
			</div>
