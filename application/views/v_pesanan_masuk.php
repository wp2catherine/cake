	...
	<div class="card card-primary card-outline card-outline-tabs">
		<div class="card-header p-0 border-bottom-0">
			<ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
				<li class="nav-item">
					<a class="nav-link active" id="custom-tabs-four-home-tab" data-toggle="pill" href="#custom-tabs-four-home" role="tab" aria-controls="custom-tabs-four-home" aria-selected="true">Incoming Orders</a>
				</li>
				<li class="nav-item">
				...
				<li class="nav-item">
					<a class="nav-link" id="custom-tabs-four-messages-tab" data-toggle="pill" href="#custom-tabs-four-messages" role="tab" aria-controls="custom-tabs-four-messages" aria-selected="false">Ship</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="custom-tabs-four-settings-tab" data-toggle="pill" href="#custom-tabs-four-settings" role="tab" aria-controls="custom-tabs-four-settings" aria-selected="false">Finish</a>
				</li>
			</ul>
		</div>
		<!-- Pesanan Masuk -->
						...
						<?php foreach ($pesanan as $key => $value) { ?>
							<tr>
								...
								<td>
									...
									<?php } else { ?>
										<span class="badge badge-success">Already Paid</span><br>
								...
								<td>
									<?php if ($value->status_bayar == 1) { ?>
										...
										<a href="<?= base_url('admin/proses/' . $value->id_transaksi) ?>" class="btn btn-sm btn-flat btn-primary">Process</a>
									<?php } ?>
						...
						<?php foreach ($pesanan_diproses as $key => $value) { ?>
							<tr>
								...
								<td>
									...
									<span class="badge badge-primary">Process/Packed</span>

								</td>
								<td>
									<?php if ($value->status_bayar == 1) { ?>

										<button class="btn btn-sm btn-flat btn-primary" data-toggle="modal" data-target="#kirim<?= $value->id_transaksi ?>"><i class="fa fa-paper-plane"></i> Ship</button>
									<?php } ?>
						...
						<?php foreach ($pesanan_selesai as $key => $value) { ?>
							<tr>
								...
								<td>
									...
									<span class="badge badge-success">Received/Arrived</span>
